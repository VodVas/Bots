...
public class UnitController : IUnitController
{
    ...
    public UnitController(Unit unit, float unitSpeed, Vector3 basePosition)
    {
        _unit = unit;
    ...
    public IResourceble GetTargetResource()
    {
        return _targetResource;
    }

    public void MoveTo(Vector3 resourcePosition, IResourceble resource)
    {
        IsAvailable = false;
